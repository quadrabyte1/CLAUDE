"""
Task 486 — run the gradient_surface_diagnostic pipeline on Los Lagos Hole 16,
but with ALL outputs (3MF, serial.json) redirected into scratch/task_486 so
nothing in EliteGolfMoments/ or its serial.json is disturbed.

Mirrors scratch/task_485/run_pipeline_isolated.py — the only difference is
the SCRATCH root and the FAKE_COURSE name.
"""
...
SCRATCH = REPO / "scratch" / "task_486"
SCRATCH.mkdir(parents=True, exist_ok=True)

FAKE_COURSE = "TaskFourEightSix"
...
out_path = Path(out)
stable = SCRATCH / "Los_Lagos_Hole_16_task_486_test.3mf"
