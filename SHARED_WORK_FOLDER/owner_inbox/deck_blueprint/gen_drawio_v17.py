"""
gen_drawio_v17.py — Generates deck_plan_v17.drawio for the West Hartford deck.

Built from scratch (not a delta on v15). All geometry derived from render_v17.py.

v17 = fully reoriented framing:
  - 2 doubled 2×10 girder lines parallel to house (x-direction)
    - Mid-girder at y=8'-0", outer-rim girder at y=16'-0"
  - 24 joists + 1 center joist perpendicular to house (y-direction)
    - Each joist: 2 segments split at mid-girder
  - Decking parallel to house, split at center breaker into 11'-9" halves
  - Center joist at x=11'-6" framing, center breaker board at x=11'-9" finish
  - 8 Pylex 50 piers (4 per girder line at x=0, 7'-8", 15'-4", 23'-0")
...
# 4 piers per girder line
PIER_SPACING_FT = FRAME_W / 3   # 7.667 ft ≈ 7'-8"
PIER_X_FT = [0.0, PIER_SPACING_FT, 2 * PIER_SPACING_FT, FRAME_W]
...
def make_piers_layer():
    ...
    for i in range(len(PIER_X_FT) - 1):
        ...
        cells.append(text_cell(
            ...
            "7&#39;-8&quot; (typ.)", fs=7, bold=True, color=C_DIM_ALT
        ))
...
def make_girders_layer():
    ...
    for gy_ft in [GIRDER_MID_Y_FT, GIRDER_RIM_Y_FT]:
        ...
        # Splice marks: Ply-1 joint at x=15'-4", Ply-2 joint at x=7'-8"
        for splice_x_ft, ply_label in [(PIER_X_FT[2], "Ply1"), (PIER_X_FT[1], "Ply2")]:
            sx = px(splice_x_ft)
            cells.append(line_cell(
                next_id("splice"), L,
                sx, y_top, sx, y_top + h,
                color="#cc4400", lw=2.0, dashed=1
            ))
            cells.append(text_cell(
                next_id("splice-lbl"), L,
                sx - 18, y_top - 14, 36, 12,
                f"SPLICE ({ply_label})", fs=5, color="#cc4400", bold=True
            ))
...
def make_callouts_layer():
    ...
    cells.append(rect_cell(
        ...
        value=(
            ...
            "8 piers total — 4 per girder line&lt;br/&gt;"
            "Pier spacing: 7&#39;-8&quot; (within DCA-6 limit of 8&#39;-2&quot;)&lt;br/&gt;"
    ...
    cells.append(rect_cell(
        ...
        value=(
            "&lt;b&gt;v17 CHANGES vs. v16&lt;/b&gt;&lt;br/&gt;"
            "• +1 center joist at x=11&#39;-6&quot; framing (16&#39;-0&quot; in 2 seg; hangers at ledger, mid-girder, outer-rim)&lt;br/&gt;"
            "• +1 center divider / breaker board (MoistureShield Vision PF stock, 5.4&quot;W × 16&#39;-0&quot; y-direction, x=11&#39;-9&quot; finish)&lt;br/&gt;"
            "• Decking now 11&#39;-9&quot; + 11&#39;-9&quot; per row — butt against breaker on both sides at x=11&#39;-9&quot; finish&lt;br/&gt;"
            "• Decking material change: was ~49×16-ft planks; now ~72×12-ft planks cut to 11&#39;-9&quot;"
        ),
    ...
    cells.append(rect_cell(
        ...
        value=(
            ...
            "v17 pier spacing = 7&#39;-8&quot; — passes with ≈6&quot; margin"
        ),
...
def make_title_layer():
    ...
    cells.append(text_cell(
        ...
        "&lt;b&gt;DECK PLAN v17 — FRAMING + DECKING PLAN&lt;/b&gt;",
    ...
    cells.append(text_cell(
        ...
        "Date: 2026-05-09  |  Gemma — Technical Diagramming Specialist",
        fs=7, color="#555555", align="center"
    ))
    cells.append(text_cell(
        next_id("title-sub"), L,
        tb_x + 4, tb_y + 66, tb_w - 8, 18,
        "v17 = center joist + breaker divider + split decking (11&#39;-9&quot; halves)",
...
<mxfile host="app.diagrams.net" type="device">
  <diagram id="deck-plan-v17-p1" name="Page 1 — Framing + Decking Plan (v17)">
...
if __name__ == "__main__":
    out_path = "/Volumes/GIT/CLAUDE/SHARED_WORK_FOLDER/owner_inbox/deck_blueprint/deck_plan_v17.drawio"
    xml = build_drawio()
