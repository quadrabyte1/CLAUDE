"""
render_v14.py  —  Gemma's matplotlib render of deck_plan v14  (Page 2: Decking Plan)
Produces deck_plan.png at >=2000 px wide, white background.

v14 = v13 + THREE changes:
...
# ══════════════════════════════════════════════════════════════════════════════
# ══ VERSION BADGE — upper-left corner (v14) ══════════════════════════════════
# ══════════════════════════════════════════════════════════════════════════════
BADGE_X = -6.4
BADGE_Y = -5.4
BADGE_W = 3.6
...
title_lines = [
    ...
    "(v14: deck depth -3\" to 16'-0\" framing for clean 16-ft stock;",
    " 3\" exposed patio at far edge; both stair elevations confirmed)",
]
...
label(PX + 0.78, y_leg + 0.09, "Exposed patio strip — 3\" (y=16'-3\" to y=16'-6\") — v14 NEW", fs=6.8, bold=True, ha="left")
