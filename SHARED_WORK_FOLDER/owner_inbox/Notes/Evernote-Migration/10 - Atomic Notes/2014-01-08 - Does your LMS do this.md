...
# [edutechnica](http://edutechnica.com/ "edutechnica")

## [EdTech Talk and Analysis](http://edutechnica.com/ "edutechnica")

[Skip to content](http://edutechnica.com/2014/01/07/a-model-for-lms-evolution/#content "Skip to content")

- [Home](http://edutechnica.com/)
-  
...
[January 7, 2014](http://edutechnica.com/2014/01/07/a-model-for-lms-evolution/ "Permalink to Does your LMS do this?")[EdTech](http://edutechnica.com/category/edtech/ "View all posts in EdTech")
...
But while the basic capabilities of the LMS haven’t changed much, their implementations have evolved significantly over time. Even so, we were surprised by [our analysis](http://edutechnica.com/2013/10/15/data-driven-campus-lms-strategy/ "Data-driven Campus LMS Strategy") showing that almost 7% of institutions continue to use legacy LMS technology. How has the LMS changed over the years, and how should schools determine where they stand in relation to each other? And where could the LMS be headed in years to come? These questions prompted us to consider what a model for thinking about LMS maturity could look like. In this post, we share our thinking with you and our thoughts about the future. Tweet or blog a reply with the hashtag [\#LMSEvolve](https://twitter.com/search?q=%23LMSEvolve&src=typd&f=realtime).
...
[← One Year Later](http://edutechnica.com/2013/11/24/one-year-later/)

## One thought on “Does your LMS do this?”

1.  Andy Fisher

    [January 8, 2014 at 11:13 am](http://edutechnica.com/2014/01/07/a-model-for-lms-evolution/#comment-68)

    I agree with you on 3rd Gen. I think we’re there already. We’re already seeing much easier integration with tools. It’s now commonplace to go to any learning tool vendor and just use the tool. Our students don’t care that the LMS is actually several pieces of software cobbled together. As long as it’s seamless.

    I see gen 4 as the blowback for the innovation. What I’m starting to see is some changes in how to handle those external tools. Tool vendors are having a difficult time adjusting to the new integrated model. This makes it hard to agree on contract language. Some schools get around this by allowing faculty to add the tools. So there is no school-vendor agreement. Instead it’s faculty-vendor. Eventually there will be some incidents related to FERPA/Accessibility/data misuse because faculty do not understand/read the license agreements. The other part is that the integrated LMS strategy is much harder on faculty. There is a reason why most faculty only use gen 1.5. It’s easy.

    That’s the challenge for gen 3/4. Make it easy. Click on something and it happens. Even better is when you don’t need to click.
...
- [Does your LMS do this?](http://edutechnica.com/2014/01/07/a-model-for-lms-evolution/)
- [One Year Later](http://edutechnica.com/2013/11/24/one-year-later/)
- [Year in Review: Top 10 LMS Developments of 2013](http://edutechnica.com/2013/11/16/top-lms-news-of-2013/)
- [Models and Preferences for LMS Deployments](http://edutechnica.com/2013/11/10/hosting-and-code-characteristics-of-institutional-lms/)
- [What’s in a Name? (LMS Edition)](http://edutechnica.com/2013/11/01/naming-your-lms/)

### Recent Comments

- Andy Fisher on [Does your LMS do this?](http://edutechnica.com/2014/01/07/a-model-for-lms-evolution/#comment-68)

### Archives

- [January 2014](http://edutechnica.com/2014/01/)
- [November 2013](http://edutechnica.com/2013/11/)
- [October 2013](http://edutechnica.com/2013/10/)

### Categories

- [EdTech](http://edutechnica.com/category/edtech/ "View all posts filed under EdTech")

### Meta

- [Log in](http://edutechnica.com/wp-login.php)
- [Entries RSS](http://edutechnica.com/feed/ "Syndicate this site using RSS 2.0")
- [Comments RSS](http://edutechnica.com/comments/feed/ "The latest comments to all posts in RSS")
